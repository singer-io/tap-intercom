...
class TestResponseErrorHandling(unittest.TestCase):
    ...
    url = 'url'
    @parameterized.expand([
        ['400_error', [400, IntercomBadRequestError, {'type': 'error.list','errors': [{'code': 'bad-request', 'message': 'Bad Request'}]}], 'HTTP-error-code: 400, Error:Bad Request, Error_Code:bad-request'],
        ['401_error', [401, IntercomUnauthorizedError, {'type': 'error.list','errors': [{'code': 'unauthorized', 'message': 'Access Token Invalid'}]}], 'HTTP-error-code: 401, Error:Access Token Invalid, Error_Code:unauthorized'],
        ['402_error', [402,IntercomPaymentRequiredError, {'type': 'error.list','errors': [{'code': 'payment_required', 'message': 'Current plan does not supports this API'}]}], 'HTTP-error-code: 402, Error:Current plan does not supports this API, Error_Code:payment_required'],
        ['403_error', [403,IntercomForbiddenError, {'type': 'error.list','errors': [{'code': 'forbidden', 'message': 'Forbidden error'}]}], 'HTTP-error-code: 403, Error:Forbidden error, Error_Code:forbidden'],
        ['404_error', [404,IntercomNotFoundError, {'type': 'error.list','errors': [{'code': 'Not Found', 'message': 'Resource not found'}]}], 'HTTP-error-code: 404, Error:Resource not found, Error_Code:Not Found'],
        ['405_error', [405,IntercomMethodNotAllowedError, {'type': 'error.list','errors': [{'code': 'Method Not allowed', 'message': 'Method not accepted'}]}], 'HTTP-error-code: 405, Error:Method not accepted, Error_Code:Method Not allowed'],
        ['406_error', [406,IntercomNotAcceptableError,  {'type': 'error.list','errors': [{'code': 'Not acceptable', 'message': 'Cannot return the requested content type'}]}], 'HTTP-error-code: 406, Error:Cannot return the requested content type, Error_Code:Not acceptable'],
        ['408_error', [408,IntercomRequestTimeoutError,  {'type': 'error.list','errors': [{'code': 'Timeout Error', 'message': 'Request timeout Error'}]}], 'HTTP-error-code: 408, Error:Request timeout Error, Error_Code:Timeout Error'],
        ['409_error', [409,IntercomUserConflictError,  {'type': 'error.list','errors': [{'code': 'Conflict Error', 'message': 'User Conflict Error'}]}], 'HTTP-error-code: 409, Error:User Conflict Error, Error_Code:Conflict Error'],
        ['415_error', [415,IntercomUnsupportedMediaTypeError,  {'type': 'error.list','errors': [{'code': 'Unsupported Media Type', 'message': 'Content-type not supported'}]}], 'HTTP-error-code: 415, Error:Content-type not supported, Error_Code:Unsupported Media Type'],
        ['422_error', [422,IntercomUnprocessableEntityError,  {'type': 'error.list','errors': [{'code': 'Unproccessable Entity', 'message': 'Data invalid'}]}], 'HTTP-error-code: 422, Error:Data invalid, Error_Code:Unproccessable Entity'],
        ['423_error', [423,IntercomScrollExistsError,  {'type': 'error.list','errors': [{'code': 'scroll_exists', 'message': 'Server overloaded'}]}], 'HTTP-error-code: 423, Error:Server overloaded, Error_Code:scroll_exists'],
        ['429_error', [429,IntercomRateLimitError,{'type': 'error.list','errors': [{'code': 'Rate Limit Error', 'message': 'Rate Limit Reached'}]}], 'HTTP-error-code: 429, Error:Rate Limit Reached, Error_Code:Rate Limit Error'],
        ['500_error', [500,IntercomInternalServiceError,{'type': 'error.list','errors': [{'code': 'Unhandled error', 'message': 'Sorry, Unhandled error with the API'}]}], 'HTTP-error-code: 500, Error:Sorry, Unhandled error with the API, Error_Code:Unhandled error'],
        ['502_error', [502,IntercomBadGatewayError,{'type': 'error.list','errors': [{'code': 'Internal error', 'message': 'Sorry, Internal Error'}]}], 'HTTP-error-code: 502, Error:Sorry, Internal Error, Error_Code:Internal error'],
        ['503_error', [503,IntercomServiceUnavailableError,{'type': 'error.list','errors': [{'code': 'Service Unavailable', 'message': 'Sorry, Service Unavailable'}]}], 'HTTP-error-code: 503, Error:Sorry, Service Unavailable, Error_Code:Service Unavailable'],
        ['504_error', [504,IntercomGatewayTimeoutError,{'type': 'error.list','errors': [{'code': 'Response Unavailable', 'message': 'Sorry, No response received'}]}], 'HTTP-error-code: 504, Error:Sorry, No response received, Error_Code:Response Unavailable'],
